...
func main() {
	...
	students.AddStudent("Danang Fathurrohman", 99)
	students.AddStudent("Adyadi", 80)
	students.AddStudent("Zen Tokyo", 79)
	students.AddStudent("May Havertz", 60)
	students.AddStudent("Siskae Ee", 82)
